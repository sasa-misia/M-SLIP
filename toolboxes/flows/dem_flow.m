function [R, S] = dem_flow(E, d1, d2, Type)
...
%   radians (default), for each pixel of E.  Pixel flow direction is measured
%   counter clockwise from the east-pointing horizontal axis.  R is NaN for 
%   each pixel of E that has no downhill neighbors.
%
...
%   the corresponding pixel of E has no downhill neighbors. Default value are 
%   given as tan(slope) but with Type 1 or Type 2 you will have deg.
%
...
[R, S] = pixel_flow(Ep, i, j, d1, d2, Type);
