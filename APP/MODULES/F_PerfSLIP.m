...
InfDet2Use = InfoDetectedSoilSlips{IndDefInfoDet};
...
TotPlyBROC = polybuffpoint2(InfDet2Use{:,{'Longitude','Latitude'}}, sqrt(2)*SzDetROC, coordType='geo', uniquePoly=true); % This is to create polygons that contains points for ROC curves. Other points are added with Ind2ndPrtPtROC
...
for i1 = 1:NumROC
    ...
    InptsCurve = inputdlg2({'Analysis label:', ...
                            ...
                            'Min number of unstable in radius (procedure 2):'}, 'DefInp',{LbNmAn, '1', '40', '1'});
    ...
    SepPlys4RP = polybuffpoint2(InfDet2Use{:,{'Longitude','Latitude'}}, SrchRadius, coordType='geo', uniquePoly=false);
