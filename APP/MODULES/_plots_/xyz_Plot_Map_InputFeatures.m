    ...
    for i2 = 1:numel(PlotOpts{i1})
        switch PlotList{PlotOpts{i1}(i2)}
            case ScatterFeats
                ...
                title(ScLeg{iSc}, [ScatterFeats{iCurr}, ScatterUnits{iCurr}], 'FontName',SlFont, 'FontSize',SlFnSz)
                fix_leg_scatter(ScLeg{iSc}, ScLegIco, ScLegPlt, DimItemScatLeg, LegPos)
                
                % fig_rescaler(ScAxs{iSc}, ScLeg{iSc}, LgndPos)
                
                if ShowTtl; title(Titles(i2), 'FontName',SlFont, 'FontSize',1.5*SlFnSz); end
            ...
            case PolygonFeats
                ...
                title(PlLeg{iPl}, PolygonFeats{iCurr}, 'FontName',SlFont, 'FontSize',SlFnSz)
            ...
            case TimeSensFeats
                ...
                for i3 = IndCum
                    ...
                    fix_leg_scatter(TSLeg{iTS}, TSLegIco, TSLegPlt, DimItemScatLeg, LegPos)
                    text(TSAxs{iTS}, 0.1, 0.9, [num2str(DaysToCumTimeSens(i3)),'d'], 'FontName',SlFont, ...
                                                                                     'FontSize',SlFnSz, ...
                                                                                     'Units','normalized')

                    % fig_rescaler(TSAxs{iTS}, TSLeg{iTS}, LgndPos)

                    if ShowTtl; title(Titles(i2+iTS-iCurr), 'FontName',SlFont, 'FontSize',1.5*SlFnSz); end
