function [ prg_curve ] = create_prg_curve2( labels,pos_scores,neg_scores,make_crossing_points )
...
labels = labels==1;
segments = create_segments2(labels,pos_scores,neg_scores);
...
if make_crossing_points
    prg_curve = create_crossing_points2(prg_curve,n_pos,n_neg);
else
